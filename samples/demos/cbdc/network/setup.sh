...
FABRIC_SAMPLES=${FPC_PATH}/samples/demos/cbdc/network/fabric-samples
...
FABRIC_SAMPLES_HOST=${FPC_PATH_HOST}/samples/demos/cbdc/network/fabric-samples
...
BE_PATH="${FPC_PATH}/samples/demos/cbdc/network/blockchain-explorer"
BE_PATH_HOST="${FPC_PATH_HOST}/samples/demos/cbdc/network/blockchain-explorer"
